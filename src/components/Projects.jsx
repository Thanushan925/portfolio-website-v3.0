                ...
                <Flex direction={{ base: 'column', xl: 'row' }} spacing={4}>
                    <Card overflow='hidden' variant='outline' borderColor='cyan.400' bg='#212121' m='1'>
                        <Stack>
                            ...
                            <CardFooter>
                                <Link href='https://kryptotracker.netlify.app/' isExternal><Button variant='outline' colorScheme='cyan' mx='1'>Demo</Button></Link>
                    ...
                    <Card overflow='hidden' variant='outline' borderColor='cyan.400' bg='#212121' m='1'>
                        <Stack>
                            ...
                            <CardFooter>
                                <Link href='https://ts-weatherverse.netlify.app/' isExternal><Button variant='outline' colorScheme='cyan' mx='1'>Demo</Button></Link>
                                <Link href='https://github.com/Thanushan925/weatherverse' isExternal><Button variant='outline' colorScheme='cyan' mx='1'>Code</Button></Link>
                            </CardFooter>
                        </Stack>
                    </Card>
                    <Card overflow='hidden' variant='outline' borderColor='cyan.400' bg='#212121' m='1'>
                        <Stack>
                            ...
                            <CardFooter>
                                <Link href='https://replit.com/@FlamingNinja925/PokemonBattleSimulator?v=1' isExternal><Button variant='outline' colorScheme='cyan' mx='1'>Demo</Button></Link>
                                <Link href='https://github.com/Thanushan925/pokemon-battle-simulator' isExternal><Button variant='outline' colorScheme='cyan' mx='1'>Code</Button></Link>
                            </CardFooter>
                        </Stack>
                    </Card>
                </Flex>
